...
public class EditEvent extends AppCompatActivity {
    ...
    private boolean validInstructorName;
    private boolean validEventName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geolocation.setChecked(old_event.getGeolocationRequired());
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!wrong && validDate && validInstructorName && validEventName) {
                    ...
                    old_event.setGeolocationRequired(geo);
